...
class TransistorMsg(mp.Message):
    ...
    class System(Enum):
        ...
        System_SendBatteryVoltage = 1
        System_QueryProtocolVersion = 2
        System_SendProtocolVersion = 3
        System_Calibrate = 4
        System_SaveCalibration = 5
        System_SetDateTime = 6
    def getSystem(self):
    ...
    # SendBatteryVoltageVoltage
    # |00 |   |   |   |   |   |   |    ||01 |   |   |   |   |   |   |    ||02 |   |   |   |   |   |   |    ||03 |   |   |   |   |   |   |    |
    # |07 |06 |05 |04 |03 |02 |01 |00  ||07 |06 |05 |04 |03 |02 |01 |00  ||07 |06 |05 |04 |03 |02 |01 |00  ||07 |06 |05 |04 |03 |02 |01 |00  |
    # |   |   |   |   |   |   |   |    ||Vo |Vo |Vo |Vo |Vo |Vo |Vo |Vo  ||Vo |Vo |Vo |Vo |Vo |Vo |Vo |Vo  ||   |   |   |   |   |   |   |    |
    def getSendBatteryVoltageVoltage(self):
        return self.get(8, 16)
    def setSendBatteryVoltageVoltage(self, in_sendbatteryvoltagevoltage):
        self.set(8, 16, in_sendbatteryvoltagevoltage)
